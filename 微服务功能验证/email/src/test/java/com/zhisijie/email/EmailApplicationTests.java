...
public class EmailApplicationTests {
    ...
    private String  receiver="sijie.zhi@qq.com";
    /**
     * 普通测试
     */
    @Test
    ...
    public void sendAttachmentsMail() {
        ...
        try {
            ...
            //注意项目路径问题，自动补用项目路径
            FileSystemResource file = new FileSystemResource(new File("src/main/resources/static/file/默写.txt"));
            //加入邮件
            helper.addAttachment("文本.txt", file);
        } catch (Exception e){
            e.printStackTrace();
        }
        mailSender.send(message);
